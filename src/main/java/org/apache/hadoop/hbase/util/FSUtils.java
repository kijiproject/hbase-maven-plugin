 ...
 *
 * <p>hbase-maven-plugin note: This file is identical to the version distributed with CDH4
 * save for a fix to accept() to change a stack trace printed on stdout into a LOG.warn.</p>
 *
 * <p>The new behavior is similar to later versions of hbase and allows us to redirect this
  ...
  public static class DirFilter implements PathFilter {
    ...
    public boolean accept(Path p) {
      ...
      try {
        ...
        // hbase-maven-plugin note: This block has been changed to log a warning instead
        // of printing a stack trace to stdout.
        LOG.warn("An IOException occurred while checking if [" + p.toString() + "]"
            + " is a valid directory. Skipping.", e);
      }
      return isValid;
    }
  }
